  ...
  return (
    <section className="bg-base-300">
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center h-screen lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center px-4 py-10 bg-base-200 sm:px-6 lg:px-8 sm:py-16 lg:py-24">
          <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
            ...
            <h2 className="text-3xl font-bold leading-tight text-center text-black dark:text-white sm:text-4xl">
              Welcome to HR Phelo
            </h2>
            ...
            <form action="#" method="POST" className="mt-8">
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="input input-bordered mt-2 flex items-center rounded gap-2">
                    <svg
