            ...
            <div className="mb-3 flex items-center border-b">
              ...
              <div className="mb-3 w-full">
                ...
                <div>
                  ...
                  <p className="mb-1">
                    Web Designer{staffDetails?.designation}
                  </p>
                  <p className="mb-1">
                    Email :{" "}
                    <span className="font-medium">{staffDetails?.email}</span>
                  </p>
                  <p>
                    Phone :{" "}
                    <span className="font-medium">{staffDetails?.contact}</span>
                  </p>
                </div>
              </div>
            </div>
